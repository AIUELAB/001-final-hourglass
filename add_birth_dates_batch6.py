...
def main():
    print("=" * 80)
    print("🎯 優先度ベース処理の継続（バッチ6）")
    print("=" * 80)

    input_file = "ultra_think_WITH_BIRTH_DATES_BATCH5_20250917_094115.csv"
    ...
    output_file = f"ultra_think_WITH_BIRTH_DATES_BATCH6_{timestamp}.csv"
