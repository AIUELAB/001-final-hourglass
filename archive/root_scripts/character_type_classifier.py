...
class CharacterTypeClassifier:
    ...
    def __init__(self):
        ...
        self.work_database = {
            ...
            # その他（アニメ）
            "スター・ウォーズ": ["ルーク・スカイウォーカー", "ダース・ベイダー", "レイア姫", "ハン・ソロ", "ヨーダ", "オビ=ワン・ケノービ"],

            # 映画（実写）
            "ハリー・ポッター": ["ハリー・ポッター", "ハーマイオニー・グレンジャー", "ロン・ウィーズリー", "アルバス・ダンブルドア", "セブルス・スネイプ", "ヴォルデモート"],
            "ロード・オブ・ザ・リング": ["フロド・バギンズ", "ガンダルフ", "アラゴルン", "レゴラス", "ギムリ", "サウロン"],
            "インディ・ジョーンズ": ["インディ・ジョーンズ", "インディアナ・ジョーンズ"],
            "007": ["ジェームズ・ボンド"],
            "ターミネーター": ["ターミネーター", "サラ・コナー", "ジョン・コナー", "T-800"],
            "バック・トゥ・ザ・フューチャー": ["マーティ・マクフライ", "ドク・ブラウン"],
            "ジュラシック・パーク": ["アラン・グラント", "イアン・マルコム"],
            "マトリックス": ["ネオ", "トリニティ", "モーフィアス"],
            "バットマン": ["バットマン", "ジョーカー", "キャットウーマン", "ロビン"],
            "スパイダーマン": ["スパイダーマン", "ピーター・パーカー"],
            "アイアンマン": ["トニー・スターク", "アイアンマン"],
            "アベンジャーズ": ["キャプテン・アメリカ", "ソー", "ハルク", "ブラック・ウィドウ"],
            ...
            # 小説
            "シャーロック・ホームズ": ["シャーロック・ホームズ", "ジョン・ワトソン", "モリアーティ教授"],
            "アルセーヌ・ルパン": ["アルセーヌ・ルパン"],
            "エルキュール・ポアロ": ["エルキュール・ポアロ", "ミス・マープル"],
            "明智小五郎": ["明智小五郎", "怪人二十面相", "小林少年"],
            "金田一耕助": ["金田一耕助"],
            "浅見光彦": ["浅見光彦"],
            "十津川警部": ["十津川省三"],
            "赤毛のアン": ["アン・シャーリー"],
            "ピーターラビット": ["ピーターラビット"],
            "くまのプーさん": ["くまのプーさん", "クリストファー・ロビン", "ピグレット", "イーヨー"],
            "不思議の国のアリス": ["アリス", "チェシャ猫", "マッドハッター", "ハートの女王"],
            "オズの魔法使い": ["ドロシー", "かかし", "ブリキの木こり", "臆病なライオン"],

            # 神話・童話・古典
            "日本昔話": ["桃太郎", "浦島太郎", "金太郎", "一寸法師", "かちかち山のたぬき"],
            "竹取物語": ["かぐや姫"],
            "グリム童話": ["白雪姫", "シンデレラ", "ヘンゼル", "グレーテル", "赤ずきん", "ラプンツェル"],
            "アンデルセン童話": ["人魚姫", "親指姫", "マッチ売りの少女", "みにくいアヒルの子"],
            "西遊記": ["孫悟空（西遊記）", "猪八戒", "沙悟浄", "三蔵法師"],
            "三国志": ["劉備", "関羽", "張飛", "諸葛亮", "曹操", "呂布"],
            "水滸伝": ["宋江", "林冲", "武松", "魯智深"],
            "イギリス伝説": ["ロビン・フッド", "アーサー王", "マーリン", "ランスロット"],
            "ギリシャ神話": ["ヘラクレス", "アキレス", "オデュッセウス", "ペルセウス"],
            "北欧神話": ["オーディン", "トール", "ロキ", "フレイヤ"],
            "イソップ寓話": ["うさぎとかめ", "アリとキリギリス"],
        }
        ...
        self.fictional_keywords = [
            ...
            'プリキュア', '戦隊', 'ライダー', 'ウルトラ',
            # 映画
            '映画', 'ハリウッド', 'マーベル', 'DC', 'MCU',
            # ドラマ
            'ドラマ', 'テレビドラマ', '連続ドラマ', '刑事ドラマ', '時代劇',
            # 小説・文学
            '文学', '推理小説', 'ミステリー', '探偵', '怪盗',
            # 神話・童話
            '童話', '昔話', '民話', '神話', '伝説', '寓話', '物語'
        ]
