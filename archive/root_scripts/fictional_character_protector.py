...
class FictionalCharacterProtector:
    ...
    def _load_protected_database(self) -> Dict[str, FictionalCharacter]:
        ...
        famous_characters = [
            ...
            # ===== 映画（実写） =====
            # ハリー・ポッター
            ('アルバス・ダンブルドア', 'Albus Dumbledore', 'ハリー・ポッター', 9.0),
            ('セブルス・スネイプ', 'Severus Snape', 'ハリー・ポッター', 9.0),
            ('ヴォルデモート', 'Voldemort', 'ハリー・ポッター', 9.5),
            ('ドラコ・マルフォイ', 'Draco Malfoy', 'ハリー・ポッター', 8.5),
            # ロード・オブ・ザ・リング
            ('フロド・バギンズ', 'Frodo Baggins', 'ロード・オブ・ザ・リング', 9.0),
            ('ガンダルフ', 'Gandalf', 'ロード・オブ・ザ・リング', 9.5),
            ('アラゴルン', 'Aragorn', 'ロード・オブ・ザ・リング', 9.0),
            ('レゴラス', 'Legolas', 'ロード・オブ・ザ・リング', 8.5),
            ('ゴラム', 'Gollum', 'ロード・オブ・ザ・リング', 9.0),
            # インディ・ジョーンズ
            ('インディ・ジョーンズ', 'Indiana Jones', 'インディ・ジョーンズ', 9.5),
            # 007
            ('ジェームズ・ボンド', 'James Bond', '007', 10.0),
            # ターミネーター
            ('ターミネーター', 'Terminator', 'ターミネーター', 9.5),
            ('サラ・コナー', 'Sarah Connor', 'ターミネーター', 8.5),
            # バック・トゥ・ザ・フューチャー
            ('マーティ・マクフライ', 'Marty McFly', 'バック・トゥ・ザ・フューチャー', 9.0),
            ('ドク・ブラウン', 'Doc Brown', 'バック・トゥ・ザ・フューチャー', 9.0),
            # マトリックス
            ('ネオ', 'Neo', 'マトリックス', 9.0),
            ('モーフィアス', 'Morpheus', 'マトリックス', 8.5),
            # バットマン/DCコミックス
            ('バットマン', 'Batman', 'バットマン', 10.0),
            ('ジョーカー', 'Joker', 'バットマン', 10.0),
            ('スーパーマン', 'Superman', 'スーパーマン', 10.0),
            ('ワンダーウーマン', 'Wonder Woman', 'ワンダーウーマン', 9.0),
            # マーベル/MCU
            ('スパイダーマン', 'Spider-Man', 'スパイダーマン', 10.0),
            ('アイアンマン', 'Iron Man', 'アベンジャーズ', 9.5),
            ('キャプテン・アメリカ', 'Captain America', 'アベンジャーズ', 9.0),
            ('ソー', 'Thor', 'アベンジャーズ', 9.0),
            ('ハルク', 'Hulk', 'アベンジャーズ', 9.0),
            ('ブラック・ウィドウ', 'Black Widow', 'アベンジャーズ', 8.5),
            ('サノス', 'Thanos', 'アベンジャーズ', 9.0),

            # ===== ドラマ =====
            ('半沢直樹', 'Hanzawa Naoki', '半沢直樹', 9.5),
            ('古畑任三郎', 'Furuhata Ninzaburo', '古畑任三郎', 9.0),
            ('杉下右京', 'Sugishita Ukyo', '相棒', 9.0),
            ('青島俊作', 'Aoshima Shunsaku', '踊る大捜査線', 9.0),
            ('久利生公平', 'Kuryu Kohei', 'HERO', 8.5),
            ('湯川学', 'Yukawa Manabu', 'ガリレオ', 8.5),
            ('大門未知子', 'Daimon Michiko', 'ドクターX', 9.0),
            ('南方仁', 'Minakata Jin', 'JIN-仁-', 8.5),

            # ===== 小説 =====
            ('シャーロック・ホームズ', 'Sherlock Holmes', 'シャーロック・ホームズ', 10.0),
            ('ジョン・ワトソン', 'John Watson', 'シャーロック・ホームズ', 9.0),
            ('モリアーティ教授', 'Professor Moriarty', 'シャーロック・ホームズ', 8.5),
            ('アルセーヌ・ルパン', 'Arsene Lupin', 'アルセーヌ・ルパン', 9.5),
            ('エルキュール・ポアロ', 'Hercule Poirot', 'エルキュール・ポアロ', 9.0),
            ('ミス・マープル', 'Miss Marple', 'ミス・マープル', 8.5),
            ('明智小五郎', 'Akechi Kogoro', '明智小五郎', 9.0),
            ('怪人二十面相', 'Kaijin Nijumenso', '少年探偵団', 8.5),
            ('金田一耕助', 'Kindaichi Kosuke', '金田一耕助', 9.0),
            ('浅見光彦', 'Asami Mitsuhiko', '浅見光彦', 8.0),
            ('アン・シャーリー', 'Anne Shirley', '赤毛のアン', 9.0),
            ('アリス', 'Alice', '不思議の国のアリス', 9.5),
            ('チェシャ猫', 'Cheshire Cat', '不思議の国のアリス', 8.5),
            ('ドロシー', 'Dorothy', 'オズの魔法使い', 9.0),

            # ===== 神話・童話・古典 =====
            # 日本昔話
            ('桃太郎', 'Momotaro', '日本昔話', 10.0),
            ('浦島太郎', 'Urashima Taro', '日本昔話', 9.5),
            ('金太郎', 'Kintaro', '日本昔話', 9.0),
            ('一寸法師', 'Issunboshi', '日本昔話', 8.5),
            ('かぐや姫', 'Kaguya-hime', '竹取物語', 9.5),
            # グリム童話
            ('白雪姫', 'Snow White', 'グリム童話', 10.0),
            ('シンデレラ', 'Cinderella', 'グリム童話', 10.0),
            ('赤ずきん', 'Little Red Riding Hood', 'グリム童話', 9.0),
            ('ラプンツェル', 'Rapunzel', 'グリム童話', 9.0),
            ('ヘンゼルとグレーテル', 'Hansel and Gretel', 'グリム童話', 8.5),
            # アンデルセン童話
            ('人魚姫', 'Little Mermaid', 'アンデルセン童話', 9.5),
            ('マッチ売りの少女', 'The Little Match Girl', 'アンデルセン童話', 8.5),
            ('みにくいアヒルの子', 'Ugly Duckling', 'アンデルセン童話', 8.5),
            # 西遊記
            ('孫悟空（西遊記）', 'Sun Wukong', '西遊記', 10.0),
            ('猪八戒', 'Zhu Bajie', '西遊記', 8.5),
            ('沙悟浄', 'Sha Wujing', '西遊記', 8.0),
            ('三蔵法師', 'Xuanzang', '西遊記', 9.0),
            # 三国志
            ('劉備', 'Liu Bei', '三国志', 9.5),
            ('関羽', 'Guan Yu', '三国志', 9.5),
            ('張飛', 'Zhang Fei', '三国志', 9.0),
            ('諸葛亮', 'Zhuge Liang', '三国志', 10.0),
            ('曹操', 'Cao Cao', '三国志', 9.5),
            ('呂布', 'Lu Bu', '三国志', 9.0),
            # イギリス伝説
            ('ロビン・フッド', 'Robin Hood', 'イギリス伝説', 9.5),
            ('アーサー王', 'King Arthur', 'アーサー王伝説', 9.5),
            ('マーリン', 'Merlin', 'アーサー王伝説', 9.0),
            # ギリシャ神話
            ('ヘラクレス', 'Heracles', 'ギリシャ神話', 9.5),
            ('アキレス', 'Achilles', 'ギリシャ神話', 9.0),
            ('オデュッセウス', 'Odysseus', 'ギリシャ神話', 9.0),
            ('ペルセウス', 'Perseus', 'ギリシャ神話', 8.5),
            # 北欧神話
            ('オーディン', 'Odin', '北欧神話', 9.0),
            ('トール', 'Thor', '北欧神話', 9.0),
            ('ロキ', 'Loki', '北欧神話', 9.0),
    ...
    def _load_work_patterns(self) -> List[Tuple[str, float]]:
        ...
        return [
            ...
            # ===== 映画（実写） =====
            (r'ロード・オブ・ザ・リング|指輪物語', 9.5),
            (r'インディ・ジョーンズ', 9.0),
            (r'007|ジェームズ・ボンド', 10.0),
            (r'ターミネーター', 9.0),
            (r'バック・トゥ・ザ・フューチャー', 9.0),
            (r'ジュラシック・パーク|ジュラシック・ワールド', 9.0),
            (r'マトリックス', 9.0),
            (r'バットマン', 10.0),
            (r'スパイダーマン', 10.0),
            (r'アベンジャーズ|MCU|マーベル', 9.5),
            (r'スーパーマン', 10.0),
            (r'DC(コミックス)?', 9.0),
            ...
            (r'シャーロック・?ホームズ', 10.0),
            (r'アルセーヌ・?ルパン', 9.5),
            (r'エルキュール・?ポアロ|アガサ・?クリスティ', 9.0),
            (r'明智小五郎|少年探偵団|江戸川乱歩', 9.0),
            (r'金田一耕助|横溝正史', 9.0),
            (r'浅見光彦|内田康夫', 8.0),
            (r'赤毛のアン', 9.0),
            (r'不思議の国のアリス|鏡の国のアリス', 9.5),
            (r'オズの魔法使い', 9.0),
            (r'ピーターラビット', 8.5),
            (r'くまのプーさん', 9.5),

            # ===== 神話・童話・古典 =====
            (r'日本昔(ばな)?話|むかしばなし', 10.0),
            (r'竹取物語|かぐや姫', 9.5),
            (r'グリム童話', 9.5),
            (r'アンデルセン童話', 9.0),
            (r'イソップ(寓話|物語)', 8.5),
    ...
    def _determine_media_type(self, work: str) -> str:
        ...
        game_works = ['スーパーマリオ', 'ゼルダの伝説', 'ファイナルファンタジー',
                     ...
                     'モンスターハンター', 'バイオハザード', 'メタルギア', 'ペルソナ']
        if any(game in work for game in game_works):
            return 'ゲーム'

        # 映画（実写）
        movie_works = ['ハリー・ポッター', 'ロード・オブ・ザ・リング', 'インディ・ジョーンズ',
                      '007', 'ターミネーター', 'バック・トゥ・ザ・フューチャー',
                      'ジュラシック・パーク', 'マトリックス', 'バットマン', 'スパイダーマン',
                      'アベンジャーズ', 'スーパーマン', 'ワンダーウーマン']
        if any(movie in work for movie in movie_works):
            return '映画'

        # ドラマ
        drama_works = ['半沢直樹', '古畑任三郎', '相棒', '踊る大捜査線', 'HERO',
                      'ガリレオ', 'ドクターX', 'JIN-仁-', '金八先生', '渡る世間は鬼ばかり']
        if any(drama in work for drama in drama_works):
            return 'ドラマ'

        # 小説
        novel_works = ['シャーロック・ホームズ', 'アルセーヌ・ルパン', 'エルキュール・ポアロ',
                      '明智小五郎', '金田一耕助', '浅見光彦', '十津川警部',
                      '赤毛のアン', '不思議の国のアリス', 'オズの魔法使い',
                      'ピーターラビット', 'くまのプーさん', 'ミス・マープル']
        if any(novel in work for novel in novel_works):
            return '小説'

        # 神話・伝説
        myth_works = ['ギリシャ神話', 'ギリシア神話', '北欧神話', 'エジプト神話', '日本神話',
                     'アーサー王', 'イギリス伝説', 'ロビン・フッド']
        if any(myth in work for myth in myth_works):
            return '神話・伝説'

        # 童話・昔話
        tale_works = ['日本昔話', '竹取物語', 'グリム童話', 'アンデルセン童話', 'イソップ']
        if any(tale in work for tale in tale_works):
            return '童話・昔話'

        # 古典文学
        classic_works = ['西遊記', '三国志', '水滸伝']
        if any(classic in work for classic in classic_works):
            return '古典文学'
        ...
        # ジブリ作品
        if work in ['となりのトトロ', '千と千尋の神隠し', 'もののけ姫', '風の谷のナウシカ',
                   '天空の城ラピュタ', '魔女の宅急便', 'ハウルの動く城']:
            return 'アニメ映画'
