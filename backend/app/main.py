...
from app.services.supabase_autosync import maybe_schedule_supabase_autosync
...
async def get_analytics_summary():
    ...
    return ScoreSummary(
        ...
        axes=[AxisStatistics(**axis) for axis in summary["axes"]],
    )
...
async def advanced_search(
    ...
    search_results = [
        EpisodeSearchResult(
            ...
            memorability_score=r.get("memorability_score", 0.0),
            empathy_score=r.get("empathy_score", 0.0),
