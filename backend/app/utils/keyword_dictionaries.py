...
ULTRA_FAMOUS_KEYWORDS: Dict[str, List[str]] = {
    'default': [
        'ギネス', 'guinness', 'guinness world records',
        '世界記録', 'world record',
        '国民的', 'national',
    ...
    '科学・技術': [
        'ノーベル賞', 'nobel prize', 'フィールズ賞',
        '世界初', 'world first', '人類初',
        '特許', '発明', '革命的発見',
        'ブレークスルー', '画期的'
    ],
    'スポーツ': [
        'オリンピック', 'olympic', '金メダル', 'gold medal',
        'ワールドカップ', 'world cup', 'MVP',
        '世界記録', 'world record', '殿堂入り',
        '歴代最高', '通算記録'
    ],
    '音楽': [
        'グラミー賞', 'grammy', 'レコード大賞',
...
def get_category_keywords(
    ...
    """
    keyword_dict = {
        'ultra_famous': ULTRA_FAMOUS_KEYWORDS,
        'famous': FAMOUS_KEYWORDS,
...
def calculate_keyword_score(
    ...
    return {
        ...
        'matched_ultra_famous': [
            kw for kw in keywords['ultra_famous']
            if kw.lower() in text_lower
        ],
        'matched_famous': [
            kw for kw in keywords['famous']
            if kw.lower() in text_lower
        ],
