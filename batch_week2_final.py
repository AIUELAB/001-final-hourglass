...
def create_week2_batch() -> List[Dict]:
    """Week 2のエピソード10件を生成（140-200文字完全対応）"""
    ...
    episodes = [
        ...
        },
        {
            ...
            "age": 66,
            "category": "建築・デザイン",
            "text": "あなたと同じ66歳のとき、隈研吾は新国立競技場を完成させて東京オリンピックの顔となった。47都道府県の木材を使用し「生命の大樹」をコンセプトに、自然と調和する日本的空間を創造。負ける建築の理念で世界30カ国300以上のプロジェクトを手がけ、21世紀の建築界をリードする革新的存在となった。"
        },
        {
            "name": "伊東豊雄",
            "age": 71,
        ...
        },
        {
            ...
            "age": 54,
            "category": "建築・デザイン",
            "text": "あなたと同じ54歳のとき、妹島和世は日本人女性初のプリツカー賞を受賞した。金沢21世紀美術館の円形ガラス建築は年間250万人が訪れる観光名所となった。ルーブル美術館ランス別館ではアルミの曲面で覆われた未来的デザインを実現。SANAAとして透明で軽やかな建築の新時代を切り開いた革新者。"
        },
        ...
        # 文化・芸術 (2件)
        {
            ...
            "age": 70,
            "category": "文化・芸術",
            "text": "あなたと同じ70歳のとき、村上春樹は『騎士団長殺し』で13年ぶりの長編小説を発表し、初版130万部の記録を樹立した。世界50カ国で翻訳され、累計発行部数は1億部を突破。ノーベル文学賞の有力候補として毎年注目され、ハルキストと呼ばれる熱狂的ファンを世界中に生み出した現代文学の巨匠。"
        },
        {
            "name": "草間彌生",
            "age": 93,
            "category": "文化・芸術",
            "text": "あなたと同じ93歳のとき、草間彌生は世界で最も影響力のある現代アーティストとして活動を継続している。水玉の無限増殖作品は1点10億円を超える評価を受け、世界5大陸の美術館で個展を開催。幻覚や幻聴を芸術に昇華し、90歳を超えても1日8時間制作に没頭する精神の闘いを創造力に変えた奇跡。"
        },
        ...
        # 宇宙・探検 (1件)
        {
            ...
            "age": 50,
            "category": "宇宙・探検",
            "text": "あなたと同じ50歳のとき、若田光一は日本人初の国際宇宙ステーション船長に就任した。15カ国の宇宙飛行士を188日間にわたって指揮し、宇宙実験300件以上を成功させた。4度の宇宙飛行で通算347日間を宇宙で過ごし、日本人最長記録を樹立。人類の宇宙進出の最前線で活躍する日本宇宙開発の誇り。"
        }
    ]
...
def main():
    ...
    # CSVファイルに保存
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    filename = f"weekly/batch_week2_final_{timestamp}.csv"
