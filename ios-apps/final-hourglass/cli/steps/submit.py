    ...
    try:
        ...
        try:
            ...
            if e.status_code == 403:
                # Legacy appStoreVersionSubmissions may fail for DEVELOPER_REJECTED
                # Try the newer reviewSubmissions API
                console.print("  [yellow]Legacy API failed. Trying reviewSubmissions API...[/yellow]")
                client.submit_via_review_submissions(app_id, version_id)
            else:
                raise
