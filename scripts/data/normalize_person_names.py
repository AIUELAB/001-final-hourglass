...
ALIAS_KEYWORDS = {
    ...
    # PERSON ID統合: 英字→日本語カタカナ正規化（追加: 2025-12-21）
    "50 Cent": "50セント",  # ラッパー
    "Notch": "マルクス・ペルソン",  # Minecraft開発者（本名）
    'Dwayne "The Rock" Johnson': "ドウェイン・ジョンソン",  # 俳優・元プロレスラー
    "The Rock": "ドウェイン・ジョンソン",  # リングネーム
    "ザ・ロック": "ドウェイン・ジョンソン",  # 日本語リングネーム
    # 今後発見された別名をここに追加
}
