...
def main():
    ...
    parser.add_argument("--output", default="generated/classical_performers_episodes.csv")
    args = parser.parse_args()

    template_path = "templates/classical_performers.csv"
            ...
            results.append(
                {
                    ...
                    "person_type": "REAL",
                    "source": "classical_performer_generation",
