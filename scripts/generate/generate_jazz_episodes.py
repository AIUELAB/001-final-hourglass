...
def main():
    ...
    parser.add_argument("--output", default="generated/jazz_episodes.csv")
    args = parser.parse_args()

    template_path = "templates/jazz_musicians.csv"
            ...
            results.append(
                {
                    ...
                    "person_type": "REAL",
                    "source": "jazz_musician_generation",
