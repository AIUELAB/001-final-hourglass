#!/usr/bin/env python3
"""
江戸時代の文化人エピソードをMASTER_EPISODES_CURRENT.csvに統合するスクリプト

使用方法:
    python3 integrate_edo_period_scholars.py
"""
...
# ファイルパス
EDO_SCHOLARS_CSV = "generated/edo_period_scholars_episodes.csv"
...
def main():
    print("=" * 80)
    print("江戸時代の文化人エピソード統合スクリプト")
    print("=" * 80)

    # 江戸時代の文化人CSV読み込み
    try:
        with open(EDO_SCHOLARS_CSV, "r", encoding="utf-8-sig") as f:
            reader = csv.DictReader(f)
            edo_scholars_rows_dict = list(reader)
            edo_scholars_header = reader.fieldnames
    except FileNotFoundError:
        print(f"❌ 江戸時代の文化人CSVが見つかりません: {EDO_SCHOLARS_CSV}")
        sys.exit(1)

    print(f"\n江戸時代の文化人エピソード: {len(edo_scholars_rows_dict)}件")
    ...
    for row_dict in edo_scholars_rows_dict:
