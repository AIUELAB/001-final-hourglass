...
DIVERSITY_TARGETS = {
    ...
    # カテゴリ分布目標（RCA-20260110: 世紀のコンテンツ誕生強化）
    "category_distribution": {
        # 主要カテゴリ（現在過剰 → さらに抑制）
        "スポーツ": 0.07,  # 8%→7%に抑制（誕生系割合7.8%と低いため）
        # 芸術・創作系（世紀のコンテンツ誕生エピソード強化）
        "芸術・文化": 0.12,  # 世紀の芸術作品誕生を増加
        "音楽": 0.10,  # 世紀の名曲誕生強化
        "文学": 0.08,
        "映画・演劇": 0.10,  # 8%→10%強化（世紀の名映画誕生）
        # その他主要
        "ビジネス": 0.08,
        "学術・研究": 0.07,  # 8%→7%調整
        "政治・社会": 0.07,  # 8%→7%調整
        "エンターテイメント": 0.06,  # 7%→6%調整
        "科学・技術": 0.08,  # 7%→8%強化（世紀の大発見誕生）
        # 充足率改善が必要なカテゴリ（優先度UP）
        "歴史": 0.05,
        "探検・冒険": 0.04,
        "医学・健康": 0.03,
