...
5. 文末を名詞で終わらせないでください（体言止め禁止）
   - 誤: 「〜を刻んだ瞬間。」「〜という存在。」「〜への挑戦。」
   - 正: 「〜を刻んだ。」「〜という存在であった。」「〜に挑戦した。」
...
- 禁止：「○○年の『作品名』」のような現実の制作年＋作品タイトル言及
- 禁止：「シリーズ」「続編」「劇場版」「第○作」など作品群への言及
- 禁止：「不朽の」「伝説の」「金字塔」など現実世界での評価表現
- 例OK: 「シャアはジオンの指揮官として連邦軍と戦った」
- 例NG: 「1979年の『機動戦士ガンダム』シリーズで不朽の存在となった」
