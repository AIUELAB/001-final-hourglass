...
class APIKeyManager:
    ...
    def load_registry(self) -> Dict:
        ...
        if REGISTRY_FILE.exists():
            with open(REGISTRY_FILE, "r", encoding="utf-8") as f:
                return json.load(f)
        return {"api_keys": {}, "last_updated": None, "version": "1.0.0"}
        ...
        try:
            ...
            if "Twitter" in file_name:
                ...
                if access_token and access_token_secret:
                    ...
                    logger.info("✅ Twitter認証情報を設定しました")
                ...
                if api_key:
                    ...
                    # レジストリに記録
                    self.registry["api_keys"][env_var] = {"file": str(file_path), "loaded": True, "env_var": env_var}
    ...
    def verify_keys(self):
        ...
        critical_keys = ["SERPAPI_API_KEY", "NEWS_API_KEY", "OPENAI_API_KEY", "ANTHROPIC_API_KEY"]
        ...
        optional_keys = ["BRAVE_API_KEY", "YOUTUBE_API_KEY", "TWITTER_API_KEY", "GITHUB_TOKEN"]
