...
SCORE_SPECS = [
    ...
    ScoreSpec("記憶性スコア", 0, 10, "0-10"),
    ScoreSpec("共感性スコア", 0, 10, "0-10"),
    ScoreSpec("意外性スコア", 0, 10, "0-10"),
    ScoreSpec("生成品質スコア", 0, 10, "0-10"),
    ScoreSpec("教育的価値", 0, 10, "0-10"),
    ScoreSpec("ストーリー品質", 0, 10, "0-10"),
    ScoreSpec("事実密度", 0, 10, "0-10"),
