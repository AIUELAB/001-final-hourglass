...
class SecureConfig:
    ...
    def _validate_required_vars(self) -> None:
        ...
        required_vars = ["GOOGLE_APPLICATION_CREDENTIALS", "GITHUB_TOKEN"]
    ...
    def firebase_credentials_path(self) -> Optional[str]:
        ...
        firebase_patterns = ["key/final-hourglass-claude-firebase-adminsdk-*.json", "key/*firebase*.json"]
    ...
    def validate_credentials(self) -> Dict[str, Any]:
        ...
        status = {"valid": True, "errors": [], "warnings": [], "credentials": {}}
