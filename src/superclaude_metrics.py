...
class SessionMetrics:
    ...
    def calculate_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "most_used_mcp": max(self.mcp_server_usage.items(), key=lambda x: x[1])[0] if self.mcp_server_usage else None,
            "parallel_tasks_ratio": sum(1 for t in self.tasks if t.parallel_count > 1) / len(self.tasks) * 100 if self.tasks else 0
        }
