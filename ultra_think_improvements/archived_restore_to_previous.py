...
"""
更に一つ前のバージョン復元スクリプト
auto_sync_20250831_045606_20250831_045606 に復元する
"""
...
def main():
    """メイン処理"""
    print("=" * 60)
    print("🔄 更に一つ前のバージョン復元システム")
    print("=" * 60)

    # 目標バージョン
    target_version = "auto_sync_20250831_045606_20250831_045606"
    ...
    print(f"📊 現在のバージョン: auto_sync_20250831_045927_20250831_045927")
    ...
    restored_csv = Path(f"ultra_think_PREVIOUS_RESTORED_{timestamp}.csv")
